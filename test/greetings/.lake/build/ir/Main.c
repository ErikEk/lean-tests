...
// Module: Main
// Imports: Init Greetings Greetings.Smile
#include <lean/lean.h>
...
extern lean_object* l_Expression_happy;
...
x_2 = l_main___closed__7;
x_3 = l_IO_println___at_main___spec__1(x_2, x_1);
return x_3;
}
}
lean_object* initialize_Init(uint8_t builtin, lean_object*);
lean_object* initialize_Greetings(uint8_t builtin, lean_object*);
lean_object* initialize_Greetings_Smile(uint8_t builtin, lean_object*);
...
lean_dec_ref(res);
res = initialize_Greetings(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Greetings_Smile(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
